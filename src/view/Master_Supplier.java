...
import tableModel.tableModel_Supplier;


public class Master_Supplier extends javax.swing.JPanel {

    private serviceSupplier servis = new daoSupplier();
    private tableModel_Supplier tblModel = new tableModel_Supplier();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(t_IdSupplier, javax.swing.GroupLayout.DEFAULT_SIZE, 818, Short.MAX_VALUE)
                    .addComponent(t_NamaSupplier)
                    .addComponent(t_TelpSupplier, javax.swing.GroupLayout.DEFAULT_SIZE, 818, Short.MAX_VALUE)
    ...
    private void loadData() {
        ...
        List<supplierModel> list = servis.getData();
    ...
    private void hapusData() {
        ...
        if (index!=-1) {
            supplierModel model = tblModel.getData(tbl_data.convertRowIndexToModel(index));
    ...
    private void perbaruiData() {
        int index = tbl_data.getSelectedRow();
        if (index!=-1) {
            supplierModel supplier_Model = tblModel.getData(tbl_data.convertRowIndexToModel(index));
            ...
            if(validasiInput()==true){
                ...
                tblModel.updateData(index, model);
                loadData();
                resetForm();
                tampilPanel();
            }
    ...
    private void pencarian() {
        List<supplierModel> list = servis.search(t_cari.getText());
        tblModel.setData(list);
    }
}
