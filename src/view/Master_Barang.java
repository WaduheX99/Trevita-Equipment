...
public class Master_Barang extends javax.swing.JPanel {
    ...
    private void setPadding() {
        ...
        t_kodeBarang.setBorder(BorderFactory.createEmptyBorder(padding.top, padding.left, padding.bottom, padding.right));
        t_kodeJenisBarang.setBorder(BorderFactory.createEmptyBorder(padding.top, padding.left, padding.bottom, padding.right));
        
        t_kodeBarang.setBorder(BorderFactory.createCompoundBorder(roundedBorder, t_kodeBarang.getBorder()));
        t_kodeJenisBarang.setBorder(BorderFactory.createCompoundBorder(roundedBorder, t_kodeBarang.getBorder()));
        t_harga.setBorder(BorderFactory.createCompoundBorder(roundedBorder, t_kodeBarang.getBorder()));
    ...
    private void initComponents() {
        ...
        t_kodeBarang = new custom.JTextFieldShadow();
        ...
        t_kodeBarang.setText("Kode Barang");
        ...
        cbx_satuan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Jenis Satuan -", "Set", "Kg", "Buah", "Roll", "Lembar", "Meter" }));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(t_kodeBarang, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        t_kodeBarang.setText(servis.nomor1());
    ...
    private custom.JTextFieldShadow t_kodeBarang;
    ...
    private void hapusData() {
        ...
        if (index!=-1) {
            barangModel brg = tblModel.getData(tbl_barang.convertRowIndexToModel(index));
    ...
    private void simpanData() {
        if(validasiInput()==true){
            ...
            String nama_jenisbarang   = t_kodeBarang.getText();
            ...
            jenisBarangModel jbr = new jenisBarangModel();
    ...
    private void perbaruiData() {
        int index = tbl_barang.getSelectedRow();
        if (index!=-1) {
            barangModel mobar = tblModel.getData(tbl_barang.convertRowIndexToModel(index));
    ...
    private void search1() {
        List<barangModel> list = servis.search1(t_cari.getText());
        tblModel.setData(list);
    }
}