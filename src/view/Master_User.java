...
public class Master_User extends javax.swing.JPanel {
    ...
    private serviceUser servis = new daoUser();
    ...
    private void initComponents() {
        ...
        cbx_level.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Pilih Akses Level -", "Owner", "Admin", "Staff" }));
    ...
    private void btn_tambah1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambah1ActionPerformed
        ...
        else if(btn_tambah1.getText().equals("UPDATE"))
        {
            updateData();
    ...
    private void loadData() {
        ...
        List<userModel> list = servis.getData();
    ...
    private void hapusData() {
        ...
        if (index!=-1) {
            userModel model = tblModel.getData(tbl_data.convertRowIndexToModel(index));
    ...
    private void simpanData() {
        if(validasiInput()==true){
            ...
            model.setTelp_user(telepon);
            model.setAlamat_user(alamat);
    ...
    private void updateData() {
        int index = tbl_data.getSelectedRow();
        if (index!=-1) {
            userModel mod_usr = tblModel.getData(tbl_data.convertRowIndexToModel(index));
    ...
    private void search() {
        List<userModel> list = servis.search(t_cari.getText());
        tblModel.setData(list);
    }
}
