...
public class Data_JenisBarang extends javax.swing.JDialog {
    ...
    public jenisBarangModel jb = new jenisBarangModel();
    ...
    private void pencarian() {
        List<jenisBarangModel> list = servis.search(t_search.getText());
    ...
    private void loadData() {
        ...
        List<jenisBarangModel> list = servis.getData(startIndex, dataPerHalaman);
        tblModel.setData(list);
    }
