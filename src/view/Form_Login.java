...
public class Form_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lb_showPassword.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/eye_login.png"))); // NOI18N
        lb_showPassword.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lb_showPasswordMouseClicked(evt);
            }
        });
        getContentPane().add(lb_showPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 180, 40, 40));

        lb_hidePassword.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lb_hidePassword.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/eye_invis.png"))); // NOI18N
        lb_hidePassword.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lb_hidePasswordMouseClicked(evt);
            }
        });
        getContentPane().add(lb_hidePassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 180, 40, 40));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/password_login.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 180, 24, 40));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/username_login.png"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 120, 24, 40));

        t_username.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        t_username.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        t_username.setText("username");
        t_username.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(254, 217, 201)));
        ...
        getContentPane().add(t_username, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 120, 220, 40));

        t_password.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        t_password.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        t_password.setText("password");
        t_password.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(254, 217, 201)));
        ...
        getContentPane().add(t_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 180, 220, 40));

        bt_login.setBackground(new java.awt.Color(254, 217, 201));
        bt_login.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        bt_login.setForeground(new java.awt.Color(255, 255, 255));
        bt_login.setText("LOGIN");
        bt_login.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        bt_login.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bt_loginActionPerformed(evt);
            }
        });
        getContentPane().add(bt_login, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 230, 220, 40));

        background.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/login_bg.png"))); // NOI18N
        getContentPane().add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 420, 360));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(254, 217, 201));
        jLabel1.setText("Trevita Equipment");
        ...
        getContentPane().add(panelRounded1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 750, 390));
    ...
    private void prosesLogin(){
        if(validasiInput()==true){
            ...
            login_Model.setId_user(id);
            login_Model.setUsername(user);
            login_Model.setPass_user(pass);
            
            servis.prosesLogin(login_Model);
            if(tutup){
                dispose();
            }
        }
