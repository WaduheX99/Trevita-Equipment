...
public class Data_Supplier extends javax.swing.JDialog {
    ...
    public supplierModel model = new supplierModel();
    ...
    private void pencarian() {
        List<supplierModel> list = servis.search(t_search.getText());
    ...
    private void loadData() {
        ...
        List<supplierModel> list = servis.getData(startIndex, entriesPerPage);
        tblModel.setData(list);
